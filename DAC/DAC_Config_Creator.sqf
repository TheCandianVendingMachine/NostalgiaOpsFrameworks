...
//===============|=============================================================================================|
	...
	if(isNil "DAC_STRPlayers")		then {		DAC_STRPlayers		= ["s1","s2","s3","s4","s5","s6"]};
	...
	DAC_SP_Soldiers		= 	["RU_Soldier_MG","USMC_Soldier_MG","GUE_Soldier_MG","CDF_Soldier_MG","Ins_Soldier_MG","CDF_Soldier_AR"];
	DAC_GunAllowed 		= 	[
