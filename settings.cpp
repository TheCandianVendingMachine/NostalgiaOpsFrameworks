...
class Header
{
	...
	minPlayers				= 0;	// Min number of players to start
	maxPlayers				= 30;	// Max number of players allowed
...
respawnDialog			= 1;	// Show the scoreboard and respawn countdown timer for a player if he is killed.

disabledAI				= 0;	// When 1, removes all playable units which do not have a human player.
